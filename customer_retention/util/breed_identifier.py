...
class BreedIdentifier():
    ...
    def identify_breed_grouping(df: pd.DataFrame):
        large = ['Greyhound', 'Bernese Mountain', 'German Shepherd', 'English Foxhound', 'Otterhound', 'Komondor',
                 ...
                 'Spinone Italiano',
                 'Tibetan Mastiff', 'Belgian Sheepdog', 'Pointer', 'Anatolian Shepherd', 'Mastiff',
                 'Black and Tan Coonhound',
                 'Belgian Tervuren', 'Leonberger', 'Borzoi', 'Giant', 'Gordon Setter', 'Afghan Hound', 'English Setter',
                 ...
                 'Saint Bernard',
                 'Bloodhound', 'Akita', 'Chesapeake Bay Retriever', 'Rhodesian Ridgeback', 'Newfoundland',
                 'Bullmastiff',
                 'Collie', 'American English Coonhound', 'Weimaraner', 'Mastiff', 'Great Dane',
        ...
        small = ['Chihuahua', 'Pomeranian', 'Maltese', 'Cavalier King Charles Spaniel', 'Silky Terrier',
                 ...
                 'Skye Terrier', 'Dandie Dinmont Terrier', 'Affenpinscher', 'Lakeland Terrier', 'Bedlington Terrier',
                 'Petit Basset', 'Griffon Vendeen', 'English Toy Spaniel', 'Miniature Bull Terrier',
                 'Australian Terrier',
                 'Norfolk Terrier', 'Manchester Terrier', 'American Eskimo Dog', 'Tibetan Spaniel',
                 'Smooth Fox Terrier',
                 'Cesky Terrier', 'Schipperke', 'Toy Fox Terrier', 'Wire Fox Terrier', 'Welsh Terrier',
                 'Norwich Terrier',
                 'Tibetan Terrier', 'Silky Terrier', 'Border Terrier', 'Japanese Chin', 'Brussels Griffon',
                 'Italian Greyhound',
                 'Lhasa Apso', 'Chinese Crested', 'Cairn Terrier', 'Scottish Terrier', 'Shiba Inu',
                 'Miniature Pinscher','doxen',
                 'Papillon', 'Shetland Sheepdog', 'Miniature Schnauzer', 'Beagle', 'Shi Zu','min pin',
